...
---@alias ENUM_RAID_FAILED_NOT_ENOUGH_RIGHTS "ENUM_RAID_FAILED_NOT_ENOUGH_RIGHTS"
---@alias ENUM_RAID_FAILED_PLAYER_IS_NOT_IN_RAID "ENUM_RAID_FAILED_PLAYER_IS_NOT_IN_RAID"
---@alias ENUM_RAID_FAILED_PLAYER_ALREADY_IN_RAID "ENUM_RAID_FAILED_PLAYER_ALREADY_IN_RAID"
---@alias ENUM_RAID_FAILED_LEADER_CANT_LEAVE "ENUM_RAID_FAILED_LEADER_CANT_LEAVE"
---@alias ENUM_RAID_FAILED_ZONE_NOT_ALLOWED "ENUM_RAID_FAILED_ZONE_NOT_ALLOWED"
---@alias ENUM_RAID_FAILED_ALREADY_FULL "ENUM_RAID_FAILED_ALREADY_FULL"
---@alias ENUM_RAID_FAILED ENUM_RAID_FAILED_NOT_ENOUGH_RIGHTS | ENUM_RAID_FAILED_PLAYER_IS_NOT_IN_RAID | ENUM_RAID_FAILED_PLAYER_ALREADY_IN_RAID | ENUM_RAID_FAILED_LEADER_CANT_LEAVE | ENUM_RAID_FAILED_ZONE_NOT_ALLOWED | ENUM_RAID_FAILED_ALREADY_FULL
